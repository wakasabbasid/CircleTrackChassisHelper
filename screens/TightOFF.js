...
class TightOFF extends Component {
    ...
    return (
      <View style={styles.container}>
        <ImageBackground source={pic} style={{ width: width, height: height - Constants.statusBarHeight }}>
          ...
          <ImageBackground source={require('../assets/TightOFF.png')} style={{ width: width, flex: 1 }} resizeMode= 'stretch'>
          </ImageBackground>
          {/*  */}
          <View style={{
            ...
            <TouchableOpacity
              ...
              <Text style={styles.contactButtonTextStyle}>TIGHT MID</Text>
            </TouchableOpacity>
          </View>
