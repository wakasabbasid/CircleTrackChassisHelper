...
class LooseMIDDLE extends Component {
    ...
    return (
      <View style={styles.container}>
        <ImageBackground source={pic} style={{ width: width, height: height - Constants.statusBarHeight }}>
          ...
          <ImageBackground source={require('../assets/LooseMIDDLE.png')} style={{ width: width, flex: 1 }} resizeMode='stretch'>
          </ImageBackground>
          {/*  */}
          <View style={{
            ...
            <TouchableOpacity
              ...
              <Text style={styles.contactButtonTextStyle}>LOOSE OFF</Text>
            </TouchableOpacity>
          </View>
