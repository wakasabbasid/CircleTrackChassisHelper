...
class TightMIDDLE extends Component {
    ...
    return (
      <View style={styles.container}>
        <ImageBackground source={pic} style={{ width: width, height: height - Constants.statusBarHeight }}>
          ...
          <ImageBackground source={require('../assets/TightMIDDLE.png')} style={{ width: width, flex: 1 }} resizeMode= 'stretch'>
          </ImageBackground>
          {/*  */}
          <View style={{
            ...
            <TouchableOpacity
              ...
              <Text style={styles.contactButtonTextStyle}>TIGHT IN</Text>
            </TouchableOpacity>
            {/*  */}
            <TouchableOpacity
            ...
            <TouchableOpacity
              ...
              <Text style={styles.contactButtonTextStyle}>TIGHT OFF</Text>
            </TouchableOpacity>
          </View>
